<?php 
    require_once '../controller/controllerCocciabeille.php';
?>
<!DOCTYPE html>
...
<body id="page-top" class="backThemeTheatre" data-spy="scroll">
    ...
    <div class="col-lg-2 divFooterGauche"></div>

    <div class="col-lg-4 textcenter divFooter">
    ...
    <div class="col-lg-2 divFooterDroite"></div>
